 ...
 * Plugin URI:      https://github.com/younes-dro/stargps.ma
...
class StarGPS_ShortCode {
	...
	public function front_page() {
		...
		$html             .= '<h3>' . esc_html__( 'Nouveauté :', 'stargps-shortcode' ) . '</h3>';
		$new_products      = array(
			'post_type'      => 'product',
			'posts_per_page' => 1,
		...
		$html .= '<h3>' . eascèhtml__( 'Étiquettes produits :', 'stargps-shortcode' ) . '</h3>';
